    ...
    <Tilt className="w-60">
      ...
      >
        <div
          ...
          className="bg-dblue rounded-[20px] py-5 px-12 min-h-[280px] flex justify-evenly items-center flex-col"
        >
    ...
    <Element name="about">
      <div className="snap-start">
        ...
        >
          ...
          Python, Java, and expertise in frameworks like React, Next, Node.js,
